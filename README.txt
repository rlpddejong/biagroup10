...
cnn.py: This is a python document with the functions needed for answering the questions in the notebook including ROC analysis and construction of FCN model.

my_first_cnn_model.json: This is the original trained cnn model of the assignment stored as a json file.
my_first_cnn_model_weights.hdf5: This is a file with the weights of the original trained cnn model.

my_first_fcn_model.json: This is the new fcn model of exercise 2 stored as a json file.
